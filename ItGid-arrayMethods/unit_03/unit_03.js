...
const f1 = () => {
a1.push(document.querySelector('.i-1').value);
...
const f2 = () => {
const item = document.querySelector('.i-2').value;
const itemSquared = Math.pow(item, 3);
a2.push(Number(item), itemSquared);
...
const f3 = () => {
  const item = document.querySelector('.i-3').value;
    // ваш код
    console.log(a3.push(item));
    console.log(a3);
}
...
const f5 = () => {
a5[a5.length] = Number(document.querySelector('.i-5').value);
return console.log(a5);
}
